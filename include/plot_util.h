...
class plot_util{
    public:
        ...
        // Plot Images
        static void plot_image(const std::vector<std::vector<float>>& data, const std::string& label = "");
        static void plot_image(const std::vector<float>& data, const int height, const int width, const std::string& label = "");
